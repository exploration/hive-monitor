...
config :hive_monitor,
  ...
  default_chat_url:
    "https://chat.googleapis.com/v1/spaces/AAAAE-QM4B4/messages?key=AIzaSyDdI0hCZtE6vySjMm-WEfRq3CPzqKqqsHI&token=AEZXKQ-qA80d05_VcFTaVd-tFq1eq-Be58Uev_Hs8UY%3D"
